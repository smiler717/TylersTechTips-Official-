-- Complete Migration Script for community_db
-- Run this in D1 Studio Console to add all advanced features
-- Date: 2025-10-29

-- ============================================
-- Step 1: Create schema_migrations tracking table
-- ============================================
...
-- ============================================
-- Step 2: Check if migrations already applied
-- ============================================
...
-- ============================================
-- Add user_id to topics and comments
...
-- ============================================
-- MIGRATION 005: Advanced Features (Notifications, Bookmarks, Audit)
-- ============================================
...
-- Add default moderation keywords
